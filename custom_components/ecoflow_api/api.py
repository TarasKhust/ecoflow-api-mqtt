...
class EcoFlowApiClient:
    ...
    def _generate_signature(
        ...
        """Generate HMAC-SHA256 signature according to EcoFlow API docs.
        
        The signature is generated by:
        1. Sorting all parameters alphabetically
        2. Concatenating them as key=value&key=value  
        3. Appending accessKey, nonce, timestamp
        4. Computing HMAC-SHA256 with secret key
        
        Based on hassio-ecoflow-cloud implementation.
        """
        # Build auth string
        ...
        if params:
            ...
            # Params come BEFORE auth string
    ...
    async def _request(
        ...
        headers = self._get_headers(sign_params)
        
        _LOGGER.debug(
            "Making %s request to %s with params=%s, data=%s",
